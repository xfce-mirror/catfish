...
class PreferencesDialog(Gtk.Dialog):
    ...
    def __new__(cls):
        ...
        """
        builder = get_builder('PreferencesCatfishDialog')
        new_object = builder.get_object("preferences_catfish_dialog")
    ...
    def finish_initializing(self, builder):
        ...
        finish initializing the start of the new PerferencesCatfishDialog
        instance.
