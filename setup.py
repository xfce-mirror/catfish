...
class BuildPot(setuptools.Command):
    ...
    def run(self):
        ...
        try:
            ...
            sys.stderr.write("Cannot generate catfish.pot.\n"
...
class Install(install):
    ...
    def run(self):
        ...
        docdir = os.path.join(self.install_data, 'share/doc/catfish')
        os.makedirs(docdir, exist_ok=True)
        self.copy_file('NEWS', docdir)
        self.copy_file('README.md', docdir)
        self.install_icons()
        self.install_man()
